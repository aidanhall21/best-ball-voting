...
const DB_PATH = process.env.DB_PATH || "./teams-2025-07-17-0834.db"; // allow override in prod
const ANALYTICS_DB_PATH = process.env.ANALYTICS_DB_PATH || "./analytics-2025-07-17-0834.db";

          ...
          if (isTournamentNotification) {
            ...
            if (notification.opponent_team_id) {
              ...
              if (againstIndex !== -1) {
                ...
                const afterAgainst = msgHtml.substring(againstIndex + 8);
                ...
                if (voteCountMatch) {
                  ...
                  if (opponentName) {
                    ...
                    const opponentLink = `<span class="desktop-opponent-link" data-team-id="${notification.opponent_team_id}" style="color:#58a6ff;cursor:pointer;text-decoration:none;">${opponentName}</span>`;
                    msgHtml = beforeAgainst + opponentLink + voteCountPart;
                  }
                }
              }
            }
